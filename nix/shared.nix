# nix/shared.nix
#
# This file provides functions used by pharo-eda-core's Nix flake.
#
# Copyright (C) 2025-today rydnr's pharo-eda-core
#
...
rec {
  shellHook-for = { nixpkgs-release, org, package, repo, tag }:
    ''
      ...
      echo -e "\033[34m|                        \033[0m                                           \033[36mhttps://github.com/nixos/nixpkgs/tree/${nixpkgs-release}\033[0m"
      echo
